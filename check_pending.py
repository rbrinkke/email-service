...
async def check_pending():
    ...
    try:
        ...
        if pending_summary and pending_summary.get('pending', 0) > 0:  # If there are pending messages
            ...
            for msg in pending_details:
                ...
                print(f"  Idle time: {msg['time_since_delivered']}ms ({msg['time_since_delivered']/1000/60:.1f} minutes)")
                ...
                claimed = await client.redis.xclaim(
                    stream_key, group_name, "debug_claimer",
