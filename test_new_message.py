...
import asyncio
import os
from email_system import EmailConfig, RedisEmailClient, EmailJob, EmailPriority, EmailProvider
...
async def test_new_message():
    ...
    print(f"   Queue sizes: high={stats.get('queue_high', 0)}, medium={stats.get('queue_medium', 0)}, low={stats.get('queue_low', 0)}")
